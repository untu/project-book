...
import {ServiceConfigurationArray} from "./configuration";
declare var ServiceConfiguration;

_.each(ServiceConfigurationArray, service => {
    ServiceConfiguration.configurations.upsert(service[0], service[1])
});
